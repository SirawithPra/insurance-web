    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      {showMobileCTA && (
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 z-30 shadow-lg">
          <Link
            to={ROUTES.CONTACT}
            className="flex items-center justify-center gap-2 w-full bg-linear-to-r from-red-600 to-red-700 text-white py-4 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl active:scale-95 transition-all"
          >
            <Phone size={20} />
            ปรึกษาที่ปรึกษาฟรี
          </Link>
